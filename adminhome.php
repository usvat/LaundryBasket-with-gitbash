<?php
    ...
    if(isset($_SESSION['user_name'])) {
      ...
      $sql ="SELECT * FROM `admin_registration` WHERE `user_name`='$user_name'";
      ...
      header("location: adminlogin.html?message=Login required!");
      exit();
    }
    ...
    <div class="imgcontainer">
      ...
      <div class="container">
        <center>
          ...
          <br>
          <p><b>Admin Name<br><?php echo $email; ?></b></p>
            ...
            <div class="row g-4" >
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s" style="background-color:white;">
                    <div class="team-item text-center p-4" style="height:300px;">
                        <br><a href="feedbackreview.php"><img class="img-fluid  " src="img/reveiw.png" alt="" width="120" height="320"></a>
                        <div class="team-text">
                            <div class="team-title">
                                <br><br><h5>Feedback Review</h5>
                                
                            </div>
                            <div class="team-social">
                                <a class="btn btn-square btn-primary rounded-circle" href="feedbackreview.php"><button style="padding:7px 7px;margin:7px 7px;border:none;background-color:dodgerblue;border-radius:8px;">CLICK</button></a>
                                </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s" style="background-color:white;">
                    <div class="team-item text-center p-4" style="height:300px;">
                        <br><a href="removeLaundry.php"><img class="img-fluid  " src="img/remove.jpg" alt="" width="100px" height="250px"a>
                        <div class="team-text">
                            <div class="team-title">
                                <br><br><h5>Remove Laundry</h5>
