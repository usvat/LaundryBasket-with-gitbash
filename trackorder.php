...
$sql = "SELECT pid FROM `placeorder`order by `pid`";
...
<!-- Navbar Start -->
    ...
    <!-- Navbar End -->
      <br><br> <center><h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Track Order Details</h3><center>
    <!-- Page Header End -->
    ...
    <?php }
        ...
        <div class="boxWrapper">
          ...
          <div class="box2">
              ...
              <form class="trackform" action="searchguest1.php" method="post" style=" width: 60%;
        margin-left : 40%">
              <body>
              <div class="user-details">
              <div class="input-box">
              <center><span class="details">Please enter Order ID<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<option></option>
            <?php
                ...
                while ($pid = mysqli_fetch_array(
                        $all_categories,MYSQLI_ASSOC)):;
            ?>
                <option value="<?php echo $pid["pid"];
...
<?php echo $pid["pid"];
            ...
            ?>
                ...
                <br><br>
                <input type="submit" name="searchServiceId" value="submit" style="position:relative;left:10;border:none;width: 300px;background-color:dodgerblue;">
      </div>
