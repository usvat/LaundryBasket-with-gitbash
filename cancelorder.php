...
style="border:none;background-color:#3399ff;color:white;"> <i class="fa fa-user-circle" style="font-size:15px"></i> Profile</button>
    ...
    <!-- Page Header Start -->
        ...
        <div class="container text-center py-5">
            <h1 class="display-4 text-black animated slideInDown mb-3">Cancel Order</h1>
<h5 >If You  Want To Cancel Just Click On It.</h5>
...
<table>
    <tr>
        ...
        <th style="background-color: dodgerblue;">Cancel Order</th>
    </tr>
    <?php
   $q="SELECT * FROM placeorder where orderStatus = 'P' AND placeorder.laundry_name = placeorder.laundry_name ORDER BY pid";
    ...
    while ($row = $result->fetch_array()) { ?>
        ...
        <tr>
            ...
            <td><a href='cancelorder.php?pid=<?= $row['pid'] ?>'><img src=img/reject.jpg width="24" height="20"></a></td>
        </tr>
    <?php } ?>
</table>
...
<div id="id03" class="modal">
  ...
  <form class="modal-content animate" action="editprofile.php" method="post">
    <div class="imgcontainer">
      <span onclick="document.getElementById('id03').style.display='none'" class="close1" title="Close Modal">&times;</span>
      <img src="./img/avtargirl.avif" alt="Avatar" style="width: 20%;height:20%;border-radius: 50%;" >
    </div>

    <div class="container"><center>
      <h3>Pritha Mishra</h3>
      <br><p><b>Customer<br>prithamjh@gmail.com</b></p>
     <button type="submit" class="button1" onclick="editprofile.php" >Edit Profile</button>
      </center>
    </div>
...
if (isset($_GET['pid'])) {
    ...
    $stmt = $mysqli->prepare("UPDATE placeorder SET orderStatus='C' WHERE pid=?");
