...
<!-- Navbar Start -->
    ...
    <!-- Page Header Start -->
        ...
        <div class="container text-center py-5">
            <h1 class="display-4 text-black animated slideInDown mb-3">Accept/Reject Order</h1>
            ...
            <table >
              ...
              <tr >
                ...
                <th style="background-color:dodgerblue;">Accept Order</th>
                <th style="background-color:dodgerblue;">Reject Order</th>

            </tr>
            <?php
  				 	$q="SELECT * FROM placeorder where orderStatus = 'P' AND placeorder.laundry_name = '$laundry_name' ORDER BY `pid`";
             ...
             <?php
              ...
              ?>
                   <tr>
                      ...
                      <td><a href='accept_reject.php?service_name=<?=$row['service_name']?>'> <img src=img/checkmark.webp width="24" height="24"></a></td>
                      <td><a href='accept_reject.php?pid=<?=$row['pid']?>'> <img src=img/reject.jpg width="24" height="20"></a></td>
                  </tr>
  				<?php } ?>
...
if (isset($_GET['service_name'])) {
    ...
    $stmt = $mysqli->prepare("UPDATE placeorder SET orderStatus='A' WHERE service_name=?");
    ...
    // Prepare and bind the SQL statement
    $stmt = $mysqli->prepare("UPDATE placeorder SET orderStatus='R' WHERE pid=?");
